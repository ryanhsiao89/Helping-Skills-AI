...
from googleapiclient.discovery import build  # 🌟 匯入 Google 官方底層 API
import traceback  # 🌟 匯入錯誤追蹤工具
...
def save_to_google_sheets(is_final=False, feedback_report="", scores_json="{}"):
    ...
    try:
        ...
        # 3. 改用 Google 官方最底層的 API 寫入 (保證不報錯)
